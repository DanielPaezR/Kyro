  ...
  const fetchClient = async () => {
    try {
      ...
      if (response.ok) {
        ...
        alert(`Error: ${error.error || 'Cliente no encontrado'}`);
      ...
      <div className="max-w-6xl mx-auto">
        <div className="mb-6">
          <div className="flex items-center space-x-4 mb-2">
            ...
            <h1 className="text-2xl md:text-3xl font-bold text-gray-800">Editar Cliente</h1>
          </div>
          <p className="text-gray-600">Actualiza la información del cliente y su ubicación</p>
        </div>

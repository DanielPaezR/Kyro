          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 mt-1">
                Identificador único en URL (se genera automáticamente si dejas vacío)
              </p>
            </div>
          </div>
...
- Reportes mensuales"
            />
            <p className="text-xs text-gray-500 mt-1">
              Cada línea será una característica mostrada en la página del producto
            </p>
          </div>
          ...
          <div>
            ...
            <input
              ...
              value={form.demoUrl || ''}
              onChange={handleChange}
              placeholder="https://demo.miproducto.com"
              className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
            <p className="text-sm text-gray-500 mt-1">
              Enlace donde los clientes pueden probar el producto
            </p>
          </div>
